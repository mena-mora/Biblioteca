        ...
        <div class="p-8 bg-gray-50">
          ...
          <form class="mt-8 space-y-5" method="POST" action="{{ route('register') }}">
            ...
            <div>
              ...
              class="mt-1 w-full rounded-lg border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-blue-500" />
            </div>
            ...
            <div>
              ...
              id="password"
                name="password"
              required placeholder="••••••••" class="mt-1 w-full rounded-lg border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-blue-500" />
            </div>
            ...
            <button type="submit" class="w-full py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Crear cuenta</button>
          </form>
        </div>
      </div>
    </section>
